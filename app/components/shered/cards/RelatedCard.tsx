  ...
  return (
    <Link href={`/movies/${id}`} className="flex gap-2">
      ...
      <div className="text-white">
        <h1 className="text-xs md:text-base lg:text-sm line-clamp-2 xl:line-clamp-2 font-semibold ">
          {fullName}
        </h1>

        <p className="text-[10px] md:text-sm lg:text-xs md:font-light line-clamp-3 pt-1 leading-tight text-gray-200">
          {description}
        </p>
      </div>
    </Link>
